...
| **Survey before fixing a distributed defect** | Two packages so far found the defect in more places than stated — 9 number-generation sites where 3 were named, 4 of 15 services covered by authorisation. A partial fix on a distributed defect looks complete and is not |
