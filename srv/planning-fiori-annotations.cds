...
annotate PlanningService.FLIGHT_FUEL_TICKETS with @(
    UI: {
        ...
        LineItem: [
            ...
            // No toolbar DataField here - see ticket_number's field-level
            // @Common.SemanticObject link below (test case for this pattern,
            // replacing the table-level DataField that resolved the wrong
            // row's context here).
        ]
    }
);
